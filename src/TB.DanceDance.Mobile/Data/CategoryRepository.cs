...
public class CategoryRepository
{
    ...
    public async Task<List<Category>> ListAsync()
    {
        ...
        while (await reader.ReadAsync())
        {
            ...
            {
                ID = reader.GetInt32(0), Title = reader.GetString(1), Color = reader.GetString(2)
            });
        }
    ...
    public async Task<Category?> GetAsync(int id)
    {
        ...
        {
            return new Category { ID = reader.GetInt32(0), Title = reader.GetString(1), Color = reader.GetString(2) };
        }
