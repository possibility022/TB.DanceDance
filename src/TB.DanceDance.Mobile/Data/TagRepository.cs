...
public class TagRepository
{
    ...
    public async Task<List<Tag>> ListAsync()
    {
        ...
        {
            tags.Add(new Tag { ID = reader.GetInt32(0), Title = reader.GetString(1), Color = reader.GetString(2) });
        }
    ...
    public async Task<Tag?> GetAsync(int id)
    {
        ...
        {
            return new Tag { ID = reader.GetInt32(0), Title = reader.GetString(1), Color = reader.GetString(2) };
        }
