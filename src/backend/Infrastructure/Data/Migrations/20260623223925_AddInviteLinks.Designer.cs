            ...
            modelBuilder.Entity("Domain.Entities.InviteLink", b =>
                {
                    ...
                    b.ToTable("InviteLinks", "access", t =>
                        {
                            t.HasCheckConstraint("CK_InviteLinks_GroupOrEvent", "(\"GroupId\" IS NOT NULL) <> (\"EventId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.InviteLink", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "RedeemedByUser")
                        .WithMany()
