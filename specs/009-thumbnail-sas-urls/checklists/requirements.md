# Specification Quality Checklist: Thumbnail Access via Stable, Cache-Friendly URLs
...
- This spec documents an **already-implemented** feature (retroactive specification) rather than
  ...
  the current code in `src/backend/Application/Features/Videos/ThumbnailUrlService.cs`,
  `src/backend/Application/Domain/Models/SasExpiry.cs`, and
  `src/my-dance.web/src/app/shared/ui/video-card/video-card.ts`. No clarification markers were
  needed.
